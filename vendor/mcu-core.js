 ...
 * Original files:
 * - /npm/@material/material-color-utilities@0.3.0/utils/math_utils.js
 * - /npm/@material/material-color-utilities@0.3.0/utils/color_utils.js
 * - /npm/@material/material-color-utilities@0.3.0/utils/string_utils.js
 * - /npm/@material/material-color-utilities@0.3.0/hct/viewing_conditions.js
 * - /npm/@material/material-color-utilities@0.3.0/hct/cam16.js
 * - /npm/@material/material-color-utilities@0.3.0/hct/hct_solver.js
 * - /npm/@material/material-color-utilities@0.3.0/hct/hct.js
 * - /npm/@material/material-color-utilities@0.3.0/palettes/tonal_palette.js
 *
 ...
 * limitations under the License.
 */
var mathUtils = { signum, lerp, clampInt, clampDouble, sanitizeDegreesInt, sanitizeDegreesDouble, rotationDirection, differenceDegrees, matrixMultiply };
/**
 ...
 * limitations under the License.
 */
var colorUtils = { argbFromRgb, argbFromLinrgb, alphaFromArgb, redFromArgb, greenFromArgb, blueFromArgb, isOpaque, argbFromXyz, xyzFromArgb, argbFromLab, labFromArgb, argbFromLstar, lstarFromArgb, yFromLstar, lstarFromY, linearized, delinearized, whitePointD65, rgbaFromArgb, argbFromRgba };
/**
 ...
 * limitations under the License.
 */
var utils = { argbFromRgb, argbFromLinrgb, alphaFromArgb, redFromArgb, greenFromArgb, blueFromArgb, isOpaque, argbFromXyz, xyzFromArgb, argbFromLab, labFromArgb, argbFromLstar, lstarFromArgb, yFromLstar, lstarFromY, linearized, delinearized, whitePointD65, rgbaFromArgb, argbFromRgba };
var math = { signum, lerp, clampInt, clampDouble, sanitizeDegreesInt, sanitizeDegreesDouble, rotationDirection, differenceDegrees, matrixMultiply };
/**
...
//# sourceMappingURL=/sm/1254482e4a19f0aa9e1a6c2e8057ca7f1c73cc846b5dabdaa9edcbda8a7a8a80.map

/* ============================================================
 * 全局暴露:将本文件中的函数/类挂到 window.MaterialColorUtilities,
 * 供 script.js 调用(argbFromHex / Hct / TonalPalette 等)。
 * 如需使用更多函数,在此处追加即可。
 * ============================================================ */
